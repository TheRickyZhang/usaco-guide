...
Generally, the structure of range DP is pretty fixed, but the collapsible structure of this painting lets you skip "most" splits by modifying the approach.
...
This optimization keeps the same worst-case bound of $O(n^3)$ in many repeats such as "01010101...." but is much faster in practice.
